DROP TABLE IF EXISTS `AutoTab_temp`;
CREATE TABLE IF NOT EXISTS `AutoTab_temp` (
...
DROP TABLE IF EXISTS `ElectroTab_temp`;
CREATE TABLE IF NOT EXISTS `ElectroTab_temp` (
...
DROP TABLE IF EXISTS `ImmobilierTab_temp`;
CREATE TABLE IF NOT EXISTS `ImmobilierTab_temp` (
...
DROP TABLE IF EXISTS `JobTab_temp`;
CREATE TABLE IF NOT EXISTS `JobTab_temp` (
...
DROP TABLE IF EXISTS `MeubleTab_temp`;
CREATE TABLE IF NOT EXISTS `MeubleTab_temp` (
...
DROP TABLE IF EXISTS `ObjArtTab_temp`;
CREATE TABLE IF NOT EXISTS `ObjArtTab_temp` (
...
DROP TABLE IF EXISTS `ProdAgrTab_temp`;
CREATE TABLE IF NOT EXISTS `ProdAgrTab_temp` (
