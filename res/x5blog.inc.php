<?php
  //Incomedia WebSite X5 - www.websitex5.com
...
?>
<div class="imBlogEmpty">Empty category</div>
<?php
		}
	}
...
?>
<div class="imBlogEmpty">Empty month</div>
<?php
		}
	}
...
?>
<div class="imBlogEmpty">Empty blog</div>
<?php
		}
	}
	function imBlogShowSearch($search) {
		...
		if(is_array($bps)) {
			...
			if($j == 0) {
?>
<div class="imBlogEmpty">Empty search</div>
<?php
			}
		}
		else {
